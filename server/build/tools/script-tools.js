...
export function registerScriptTools(server, godot) {
    ...
    server.tool("create_script", "Create a new GDScript file with optional content or auto-generated template", {
    ...
    server.tool("edit_script", "Edit a script using search-and-replace, full content replacement, or line insertion", {
