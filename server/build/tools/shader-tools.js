...
export function registerShaderTools(server, godot) {
    server.tool("create_shader", "Create a new shader file with a template or custom content", {
    ...
    server.tool("edit_shader", "Edit a shader file using full replacement or search-and-replace", {
        path: z.string().describe("Path to the shader file"),
