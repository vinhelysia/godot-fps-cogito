...
async function main() {
    ...
    godot.connect().catch((err) => {
        console.error(`[MCP] Initial Godot connection failed: ${err.message}. Will retry on first command.`);
    });
    if (HTTP_MODE) {
        ...
        const httpServer = createServer(async (req, res) => {
            ...
            if (url.pathname === "/mcp") {
                ...
                if (!normalizedAccept.includes("application/json") || !normalizedAccept.includes("text/event-stream")) {
